...
- expands the TenneT live connector surface from settlement prices into live Dutch reserve ladders, activation volumes, and derived activation price / ratio series
- keeps Belgium as the narrow GA promise while lifting the explicit Netherlands aFRR runtime rejection

## v1.1.1

- hardens the live TenneT connector contract around settlement-price ingestion
